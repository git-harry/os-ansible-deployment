...
class Connection(object):
    ...
    def exec_command(self, *args, **kwargs):
        ...
        remaining_tries = C.get_config(
            C.p, 'ssh_retry', 'attempt_count',
            'ANSIBLE_SSH_RETRY_ATTEMPT_COUNT', 3, integer=True)
    ...
    def _exec_command(self, cmd, tmp_path, sudo_user=None, sudoable=False,
                      executable='/bin/sh', in_data=None, su_user=None,
                      su=False):
